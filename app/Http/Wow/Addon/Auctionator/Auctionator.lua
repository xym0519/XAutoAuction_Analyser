...
function Atr_CreateAuction_OnClick ()
	...
	local sellTime = time();
	local xxKey = gJustPosted_ItemName .. ":" .. time();
	local sellHistory = {itemName= gJustPosted_ItemName, sellTime= sellTime, price= stackBuyoutPrice/gJustPosted_StackSize, count=gJustPosted_StackSize*gJustPosted_NumStacks, stackPrice= stackBuyoutPrice, stackSize= gJustPosted_StackSize, stackCount= gJustPosted_NumStacks};
	XXSellHistory[xxKey] = sellHistory;
